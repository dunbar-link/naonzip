/**
 * 우슐랭(우체국 추천 맛집가이드 2026) 4차 신규 3곳 등록:
 *   봉래화로 / 순풍삼계탕 / 해주냉면.
 *
 * 1·2·3차(register-postoffice-batch1/2/3.mjs)와 동일 패턴. guide 출처이므로 appearances 안 만든다.
 * 출처는 restaurants.source_type=guide + restaurant_trust_sources("우체국 추천 맛집가이드 2026").
 *
 * 절차(안전):
 *   - dry-run : 중복 재검사 + 계획만(DB 무변경).
 *   - --apply --confirm APPLY_POSTOFFICE_BATCH4 :
 ...
 * 실행:
 *   node scripts/register-postoffice-batch4.mjs                                   # dry-run
 *   node scripts/register-postoffice-batch4.mjs --apply --confirm APPLY_POSTOFFICE_BATCH4
 *   node scripts/register-postoffice-batch4.mjs --publish
 */
...
const APPLY_TOKEN = 'APPLY_POSTOFFICE_BATCH4'
...
const ROWS = [
  { slug: 'postoffice-yeongdo-bongnae-hwaro', name: '봉래화로', area: '영도', address: '부산광역시 영도구 대교로 1, 101호', lat: 35.0926737511788, lng: 129.044243249941, category: '고기', main_menu: '보석살·황제갈비살·보석살정식', price_text: '보석살(130g) ₩16,900 | 황제갈비살(130g) ₩14,900 | (평일런치)보석살정식 ₩14,500', phone: '0507-1416-7930', place_id: '1972140778', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 영도의 한우 화로구이 식당.' },
  { slug: 'postoffice-sasang-sunpung-samgyetang', name: '순풍삼계탕', area: '사상', address: '부산광역시 사상구 사상로181번길 33', lat: 35.1597563884913, lng: 128.985443217797, category: '한식', main_menu: '삼계탕·전복삼계탕', price_text: '삼계탕 ₩15,000 | 전복삼계탕 ₩19,000', phone: '051-324-6622', place_id: '16669936', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 사상의 삼계탕·전복삼계탕 보양식당.' },
  { slug: 'postoffice-saha-haeju-naengmyeon', name: '해주냉면', area: '기타', address: '부산광역시 사하구 낙동대로324번길 5', lat: 35.1006494109164, lng: 128.981723291788, category: '밀면', main_menu: '비빔냉면·물냉면·물밀면·밀비빔', price_text: '비빔냉면 ₩12,000 | 물냉면 ₩12,000 | 물밀면 ₩9,000 | 밀비빔 ₩9,000', phone: '051-291-4841', place_id: '21295360', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 사하의 냉면·밀면 전문점.' },
]
