/**
 * 우슐랭(우체국 추천 맛집가이드 2026) 5차 신규 3곳 등록:
 *   연돼지국밥 / 공항족발 / 동래밀면.
 *
 * 1~4차(register-postoffice-batch1~4.mjs)와 동일 패턴. guide 출처이므로 appearances 안 만든다.
 * 출처는 restaurants.source_type=guide + restaurant_trust_sources("우체국 추천 맛집가이드 2026").
 *
 * 절차(안전):
 *   - dry-run : 중복 재검사 + 계획만(DB 무변경).
 *   - --apply --confirm APPLY_POSTOFFICE_BATCH5 :
 ...
 *       돼지국밥 category 는 기존 canonical(DB 내 다수 존재) — 신규 enum 아님.
 * 실행:
 *   node scripts/register-postoffice-batch5.mjs                                   # dry-run
 *   node scripts/register-postoffice-batch5.mjs --apply --confirm APPLY_POSTOFFICE_BATCH5
 *   node scripts/register-postoffice-batch5.mjs --publish
 */
...
const APPLY_TOKEN = 'APPLY_POSTOFFICE_BATCH5'
...
const ROWS = [
  { slug: 'postoffice-busanjin-yeon-dwaeji-gukbap', name: '연돼지국밥', area: '서면', address: '부산광역시 부산진구 범일로192번길 33', lat: 35.1468292204556, lng: 129.061649642976, category: '돼지국밥', main_menu: '돼지국밥·순대국밥·모듬국밥', price_text: '돼지국밥 ₩9,000 | 순대국밥 ₩9,000 | 모듬국밥 ₩10,000', phone: '0507-1301-1376', place_id: '1415088420', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 부산진구 범일동의 돼지국밥·순대국밥 전문점.' },
  { slug: 'postoffice-gangseo-gonghang-jokbal', name: '공항족발', area: '기타', address: '부산광역시 강서구 공항앞길 12, 1층', lat: 35.1802620269846, lng: 128.954183242134, category: '고기', main_menu: '삼미리앞발·반반족발·두루치기정식', price_text: '삼미리앞발 ₩42,000 | 반반족발(소) ₩45,000 | (점심특선)두루치기정식 ₩12,000', phone: '0507-1402-1781', place_id: '1688432879', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 강서 대저의 족발·두루치기 전문점.' },
  { slug: 'postoffice-dongnae-milmyeon', name: '동래밀면', area: '동래', address: '부산광역시 동래구 명륜로 47', lat: 35.1983246042788, lng: 129.084200429359, category: '밀면', main_menu: '밀면·비빔밀면·왕만두·들깨손칼국수', price_text: '밀면 ₩8,000 | 비빔밀면 ₩8,000 | 왕만두 ₩7,000 | 들깨손칼국수 ₩8,000', phone: '051-552-3092', place_id: '12519573', description: '부산지방우정청 「우체국 추천 맛집가이드 2026」에 선정된 동래 명륜동의 밀면·비빔밀면 전문점.' },
]
